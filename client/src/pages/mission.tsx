    ...
    <div className="min-h-screen bg-background text-foreground overflow-hidden flex flex-col">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b-0 py-4 px-6 md:px-12 flex justify-between items-center text-[#ffffff] bg-[#1a6660] shadow-md">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium">
          <Link href="/mission" className="transition-colors text-[#a0e4dc]">Mission</Link>
      ...
      {/* Main Content */}
      <div className="pt-36 px-6 md:px-12 max-w-4xl mx-auto w-full">
      ...
      <section className="pb-24 px-6 md:px-12 max-w-4xl mx-auto w-full flex-grow">
        <motion.div
